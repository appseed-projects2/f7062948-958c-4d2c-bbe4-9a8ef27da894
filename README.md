...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-03 21:15`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f7062948-958c-4d2c-bbe4-9a8ef27da894.git
$ cd f7062948-958c-4d2c-bbe4-9a8ef27da894
```
